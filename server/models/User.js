...
// Instead on encoding the password in the controller we can encode it here
...
UserSchema.pre("save", async function () {
  // 10 is default value
  // Increase the value for stronger encoding but it requires more processing power
